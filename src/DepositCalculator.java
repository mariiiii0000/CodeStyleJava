...
public class DepositCalculator {
    ...
    double calculateSimplePercent(double doubleAmount, double yearRate, int deposit_period) {
        // Я в шоке, зачем нужнен "double" для названия переменных в параметре,прошу исправить данную проблему.Спасибо за понимание!
        return round(doubleAmount + doubleAmount * yearRate * deposit_period, 2);
    }

    double round(double value, int places) {
        double scale = Math.pow(10, places);
        return Math.round(value * scale) / scale;
        //Мария,я нахожусь в агонии, почему переменная названа с БОЛЬШОЙ БУКВЫ И ЛАТИНСКАЯ БУКВА "L" ТОЖЕ С БОЛЬШОЙ!прошу
        // вас исправить эту проблему.Спасибо за понимание!Всех благ вам.Merry Xmas!
    }
